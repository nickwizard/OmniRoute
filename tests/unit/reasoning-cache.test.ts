...
describe("Reasoning Replay Cache — Translator Replay", () => {
  ...
  it("should inject cached reasoning for DeepSeek instead of empty fallback", () => {
    ...
    cacheReasoning("call_translate_ds", "deepseek", "deepseek-v4-flash", "DeepSeek cached plan");
  ...
  it("should preserve client-provided reasoning content", () => {
    ...
    cacheReasoning("call_preserve", "deepseek", "deepseek-v4-flash", "Cached reasoning");
  ...
  it("should support the full capture then replay flow", () => {
    ...
    const translated = translateWithToolHistory("deepseek", "deepseek-v4-flash", "call_full_flow");
